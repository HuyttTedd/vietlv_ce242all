...
class EventData implements EnvironmentDataInterface
{
    /**
     * @var Reader
     */
    ...
    public function capture()
    {
        ...
        foreach ($areas as $area) {
            foreach ($this->reader->read($area) as $observers) {
                foreach ($observers as $observer) {
                    $reflection = $this->getObserverReflection($observer);
                    if (!$reflection) {
                        continue;
                    }
     ...
     */
    private function getObserverReflection(array $observer)
    {
