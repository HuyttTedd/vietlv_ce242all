...
class DiscountRegistry
{
     ...
     */
    public const DISCOUNT_REGISTRY_DATA = 'amasty_rules_discount_registry_data';
    public const DISCOUNT_REGISTRY_SHIPPING_DATA = 'amasty_rules_discount_registry_shipping_data';
