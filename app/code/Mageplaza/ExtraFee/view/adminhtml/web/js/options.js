    ...
    return function (config) {
        var attributeOption = {
            ...
            ignoreValidate: function () {
                var ignore = '.ignore-validate input, .ignore-validate select, .ignore-validate textarea';
        ...
        var applyType = jQuery('#rule_apply_type'),
            options = jQuery('#rule_options'),
            checkOptionsShow = function () {
                if (applyType.val() === '1') {
                    options.hide();
                } else {
                    options.show();
