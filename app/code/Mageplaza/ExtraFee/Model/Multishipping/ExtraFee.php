...
class ExtraFee
{
            ...
            foreach ($extraFee as $ruleId => $option) {
                ...
                if (is_array($option)) {
                    foreach ($option as $item) {
                        list($baseRuleFeeAmount, $ruleFeeAmount, $baseRuleFeeAmountInclTax, $ruleFeeAmountInclTax) =
    ...
    public function getApplyRule($address, $area)
    {
        ...
        foreach ($area as $item) {
            list($applyRule[], $selectedOptions[]) = $this->quoteExtraFee->checkApplyRule($address, $item, true);
        }
