...
namespace Mageplaza\CustomizeOsc\Controller\Index;

use Mageplaza\CustomizeOsc\Helper\Data as Onepage;
use Mageplaza\CustomizeOsc\Model\Config;
...
class Index extends \Magento\Checkout\Controller\Index\Index
{
    ...
    public function execute()
    {
        ...
        $checkoutBlock
            ->setTemplate('Mageplaza_CustomizeOsc::onepage.phtml')
            ->setData('customizeosc_helper', $this->onepageHelper);
    ...
    private function prepareResultPage()
    {
        ...
        $resultPage->getLayout()->getUpdate()->addHandle('customize_osc');
