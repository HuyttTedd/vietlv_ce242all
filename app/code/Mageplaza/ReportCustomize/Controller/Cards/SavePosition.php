...
namespace Mageplaza\ReportCustomize\Controller\Cards;
...
/**
 * Class SavePosition
 * @package Mageplaza\ReportCustomize\Controller\Adminhtml\Cards
 */
    ...
    public function execute()
    {
        ...
        if ($items && $this->getRequest()->isAjax()) {
            ...
            if ($config->getId()) {
                ...
                $config->setData([
                    'namespace'  => 'customize_reports_cards_mobile',
                    'user_id'    => '1',
                    'identifier' => 'current',
                    'config'     => $data
                ])->save();
