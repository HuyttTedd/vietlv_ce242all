...
class Category extends AbstractFilter
{
    ...
    protected function getFacetedData()
    {
        /** @var Collection $productCollection */
        $productCollection = $this->getLayer()->getProductCollection();
        $this->getLayer()->setData('current_category', $this->categoryRepository->get($this->getCurrentCategoryId()));
        ...
        $faceData = $productCollection->getFacetedData('category');
        $this->getLayer()->setData('current_category');
