...
return [
    'modules' => [
        ...
        'RealexPayments_Inquiry' => 1,
        'Smartosc_CustomCheckout' => 1,
        'Smartosc_MidSplitPayment' => 1,
        'Smartosc_PayPalBraintree' => 1,
        'Smartosc_RealexPayments' => 1,
